...
lrtRoutes = json.loads(open(JSON_FOLDER + "lrt_routes.json").read())
LrtRoute0 = json.loads(open(JSON_FOLDER + "LrtRoute0.json").read())
LrtRoute1 = json.loads(open(JSON_FOLDER + "LrtRoute1.json").read())
